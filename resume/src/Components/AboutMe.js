                ...
                <table>
                    <tr>
                        <td className="AMCell">
                            <p>
                                <strong>
                                    During my time at Carleton University, where I completed my degree in Software Engineering amid the challenges posed by the COVID era, I honed a diverse set of skills: <br/>
                                </strong>
                                <br/>
                                ...
                                - Programming Skills: Proficent in Java and Python, with a solid understanding of algorithmic complexities and modern software design principles.<br/>
